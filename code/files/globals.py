...
project_path = '/home/mszmelcz/kaggle-competitions/Humpback-Whale-Identification/data/input/' # project path for ubuntu
...
train_examples = project_path + 'train_examples.pickle'
